...
const collections = [
  {
    ...
    description:
      "Radiant products to achieve that perfect summer glow, from bronzers to illuminating primers.",
    image:
  ...
  },
  {
    ...
    description:
      "A luxurious collection featuring rose gold packaging and warm, flattering shades for all skin tones.",
    image:
  ...
  },
  {
    ...
    name: "Bold & Bright",
    description:
      "Vibrant, bold colors for eyes, lips, and cheeks that make a statement and showcase your creativity.",
    image:
  ...
  },
  {
    ...
    description:
      "High-quality makeup brushes for flawless application, designed by professional makeup artists.",
    image:
  ...
  },
  {
    ...
    name: "Night Glamour",
    description:
      "Shimmering, long-lasting formulas perfect for special occasions and nighttime events.",
    image:
  ...
  },
  {
    ...
    name: "Clean Beauty",
    description:
      "Non-toxic, clean beauty products free from harmful chemicals, parabens, and synthetic fragrances.",
    image:
          ...
          <div className="relative h-[50vh] rounded-2xl overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full md:w-2/3">
              <span className="inline-block bg-primary text-white text-xs font-semibold px-3 py-1 rounded-full mb-4">
                {t("collections.limitedEdition")}
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                {t("collections.holidayGlam")}
              </h2>
              <p className="text-white/90 mb-6">
                {t("collections.holidayDescription")}
              </p>
              <div className="flex items-center text-white/80 text-sm mb-6">
                <span>18 {t("collections.products")}</span>
                <span className="mx-3">•</span>
                <span>{t("collections.limitedTime")}</span>
              </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center text-primary font-medium">
                    <span>{t("collections.exploreCollection")}</span>
                    <svg
          ...
          <div className="bg-accent rounded-2xl p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-center gap-3">
                <input
                  type="email"
                  placeholder={t("collections.newsletter.emailPlaceholder")}
